    ...
    <ConfirmProvider>
      <ToastProvider>
        <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', background: '#111' }}>
          ...
          <PullToRefresh />
          <Navbar />
          <main className="app-main" style={{ flex: 1, minHeight: 0, padding: '24px calc(20px + env(safe-area-inset-right)) calc(24px + env(safe-area-inset-bottom)) calc(20px + env(safe-area-inset-left))' }}>
